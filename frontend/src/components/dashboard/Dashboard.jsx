          ...
          <ul ref={logoutRef} className="dashboard__logout--list">
            <li className="dashboard__logout--list--item">
              <Link to="/account/login" onClick={handleLogout}>
                Đăng xuất <i className="fa-solid fa-right-to-bracket"></i>
              </Link>
            </li>
          </ul>
        </div>
              ...
              <ul ref={productRef} className="dashboard__menu--item-list">
                ...
                <li className="dashboard__menu--item-list-item">
                  <Link to="/dashboard/products">
                    <i className="fa-solid fa-border-all"></i> Quản lý sản phẩm
                  </Link>
                </li>
              </ul>
            </div>
              ...
              <ul ref={orderRef} className="dashboard__menu--item-list">
                ...
                <li className="dashboard__menu--item-list-item">
                  <Link to="/dashboard/orders">
                    <i className="fa-solid fa-border-all"></i> Quản lý đơn hàng
                  </Link>
                </li>
              </ul>
            </div>
              ...
              <ul ref={userRef} className="dashboard__menu--item-list">
                ...
                <li className="dashboard__menu--item-list-item">
                  <Link to="/dashboard/users">
                    <i className="fa-solid fa-border-all"></i> Quản lý tài khoản
                  </Link>
                </li>
              </ul>
            </div>
