        ...
        <div className="grid wide">
            ...
            <ul className="header__navbar-list">
              <li className="header__navbar-item">
                <Link to="/shop" className="header__navbar-item-link">
                  <div className="header__navbar-icon-link">
                    <i className="header__navbar-icon fa-solid fa-shop"></i>
                  </div>
                  <div className="header__navbar-item-link">Shop</div>
                </Link>
              </li>
              <li className="header__navbar-item header_notify-hover">
                <Link to="#" className="header__navbar-item-link">
                  ...
                  <div className="header__navbar-item-link "> Thông báo</div>
                </Link>
              ...
              <li className="header__navbar-item">
                <Link to="#" className="header__navbar-item-link">
                  ...
                  <div className="header__navbar-item-link">Trợ giúp</div>
                </Link>
              </li>
              {isAuthenticated ? (
                <li className="header__navbar-user">
                  ...
                  <ul className="header__navbar-user-list">
                    <li className="header__navbar-user-item">
                      <Link to="/me/profile">Thông tin tài khoản</Link>
                    </li>
                    <li className="header__navbar-user-item">
                      <Link to="/myorder">Đơn đặt hàng</Link>
                    </li>
                    <li className="header__navbar-user-item">
                      <Link to="/mycard">Giỏ hàng</Link>
                    </li>
                    <li className="header__navbar-user-item">
                      <Link to="/dashboard/main">Trang quản trị</Link>
                    </li>
                    <li className="header__navbar-user-item">
                ...
                <>
                  <li className="header__navbar-item login">
                    <Link to="/account/login" className="header__navbar-item-link">
                      <div className="header__navbar-item-link">Đăng nhập</div>
                    </Link>
                  </li>
                  <li className="header__navbar-item">
                    <Link to="/account/register" className="header__navbar-item-link">
          ...
          <div className="header__with--search">
            ...
            <div className="header__search--find">
              <div className="header__search--filler">
                ...
                <div ref={historySearchRef} className="header__history">
                  <h3 className="header__history--text">Lịch sử Tìm kiếm</h3>
                  <ul className="header__history-list">
                    {
                      historyCard?.length > 0
                        ? historyCard.slice(0, 4).map((history, i) => (
                            <li
                              onClick={(e) => {
                                handleCheckoutHistory(e, history);
                              }}
                              key={i}
            ...
            <div className="header__cart">
              ...
              {
                productCart.length > 0 && <span className="header__cart--sum ">
                {productCart.length}
              </span>
              }
